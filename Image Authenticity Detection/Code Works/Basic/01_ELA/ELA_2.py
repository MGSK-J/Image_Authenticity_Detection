...
def detect_manipulation(image_path, output_path="output.jpg", quality=90, threshold=12, kernel_size=(3, 3)):
    # Read original image
    ...
    original = cv2.normalize(original, None, 0, 255, cv2.NORM_MINMAX)
    ...
    # Convert ELA to grayscale for analysis
...
# Usage example
detect_manipulation("test.jpg", output_path="result.jpg", quality=90, threshold=12, kernel_size=(5, 5))